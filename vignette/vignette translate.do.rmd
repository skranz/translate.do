...
The functions .clear, .use, ... are implemented in the package translate.do and try to implement in R the intended functionality of these commands. Currently, the scope of the package is quite limited:
...
```
  ...
  - 
    ...
    - The remaining omitted code tries to implement the desired behavior in R.
  ...
  - The file dotdot_functions.r,  contains implementations of .do file functions like `substr`, which are renamed by adding .., e.g. `..substr`. They implement the desired transformation of their arguments in R.
